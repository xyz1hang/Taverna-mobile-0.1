...
public class DetailsPreviewFragment extends DetailsFragmentsBase implements CallbackTask {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(R.layout.workflow_detail_preview, container, false);
	}
	...
	private void loadImage() {
		...
		if(imageBitmap != null){
			...
			Drawable finalImage = 
					new BitmapDrawable(getResources(), Bitmap.createScaledBitmap(imageBitmap, 200, 200, true));
